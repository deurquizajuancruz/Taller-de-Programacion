...
var
	o:oficina;
begin
	writeln('Ingrese el codigo de identificacion de la oficina: ');readln(o.codigo);
	while (o.codigo<>-1) and (diml<dimf) do begin
		diml:=diml +1;
		writeln('Ingrese el dni del propietario de la oficina: ');readln(o.dni);
		writeln('Ingrese el valor de la expensa de la oficina: ');readln(o.valorexpensa);
		v[diml]:=o;
		writeln('Ingrese el codigo de identificacion de la oficina: ');readln(o.codigo);
	end;
end;
...
begin
	for i:=2 to diml do begin actual:=v[i].codigo;
	j:=i-1;
